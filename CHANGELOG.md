...
- Rebranded the workstation as SID OS — Metrally.
- Added the production Vite build and pnpm lockfile.
- Fixed duplicate entrypoint loading and the stale page title.
- Deferred AudioContext creation until explicit user interaction.
